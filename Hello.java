...
// if (firstNumber.matches("[0-9]+(\\.[0-9]+)?") &&
// secondNumber.matches("[0-9]+(\\.[0-9]+)?")) {
...
// System.out.print("The difference of " + firstNumber + " and " + secondNumber
// + " is "
// + mathsObject.subtraction(firstNumberDouble, secondNumberDouble));
// } else if (operationCount == 3) {
// System.out.print("The multiplication of " + firstNumber + " and " +
// secondNumber + " is "
// + mathsObject.multiplication(firstNumberDouble, secondNumberDouble));
// } else {
// System.out.print("The result of " + firstNumber + " divided by " +
// secondNumber + " is "
